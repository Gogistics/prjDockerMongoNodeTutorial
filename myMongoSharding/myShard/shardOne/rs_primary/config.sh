...
echo "rs.add('198.74.48.34:27031')" >> authentication.js
echo "sleep(1000)" >> authentication.js
echo "rs.addArb('198.74.48.34:27032')" >> authentication.js
echo "sleep(1000)" >> authentication.js
echo "rs.status()" >> authentication.js
echo "cfg = rs.conf()" >> authentication.js
echo "cfg.members[0].host = '198.74.48.34:27030'" >> authentication.js
